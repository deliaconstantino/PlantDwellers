...
basil = Plant.create(common_name: "basil", scientific_name: "Ocimum basilicum", watering_schedule: "3 per week", rotation_schedule: "1 per month", fertilization_schedule: "1 per season", location: "porch", size: "small", category: "herb", dweller_id: caroline.id)
palm_tree = Plant.create(common_name: "palm tree", scientific_name: "Arecaceae", watering_schedule: "2 per week", rotation_schedule: "1 per month", fertilization_schedule: "1 per season", location: "porch", size: "large", category: "tree", dweller_id: scott.id)
bromeliad = Plant.create(common_name: "bromeliad", scientific_name: "bromeliad", watering_schedule: "2 per week", rotation_schedule: "1 per month", fertilization_schedule: "1 per season", location: "living room", size: "medium", category: "flower", dweller_id: kyle.id)
powder_puff = Plant.create(common_name: "powder puff", scientific_name: "Mammillaria bocasana", watering_schedule: "2 per month", rotation_schedule: "1 per season", fertilization_schedule: "1 per season", location: "living room", size: "small", category: "succulent", dweller_id: delia.id)
...
#scottie1 plantspass id: 4 home.id == 1
